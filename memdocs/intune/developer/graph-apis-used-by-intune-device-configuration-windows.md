...
ms.locfileid: "79364751"
---
# <a name="graph-apis-and-matching-windows-10-csps-used-in-intune"></a>Graph API 및 Intune에서 사용되는 Windows 10 CSP 일치
...
**CSP**:./Device/Vendor/MSFT/BitLocker  
**OFFSET URI**://RemovableDrivesRequireEncryption methodbydrivetype,
...
**CSP**:./Device/Vendor/MSFT/BitLocker  
**OFFSET URI**:/Encryptionmethodbydrivetype,/System\esurstartupauthentication,/Encryptionmethodbydrivetype pinlength,/Systemneesrecoverymessage,/Systemvesrecoveryoptions
...
**CSP**:./Device/Vendor/MSFT/Policy  
**OFFSET URI**:/Config/LocalPoliciesSecurityOptions/Accounts\_Enable관리자 accountstatus
...
**CSP**:./Vendor/MSFT/Policy  
**OFFSET URI**:/Config/LocalPoliciesSecurityOptions/InteractiveLogon\_Displayuserinformation고정
...
**CSP**:./Device/Vendor/MSFT/Policy  
**오프셋 URI**:/Config/RemoteManagement/AllowBasicAuthentication\_서비스
...
**CSP**:./Device/Vendor/MSFT/Policy  
**오프셋 URI**:/Config/RemoteManagement/AllowUnencryptedTraffic\_서비스
...
**CSP**: n/a Graph API 호출 전용 **오프셋 URI**: n/a Graph API 호출만
...
**CSP**:./Device/Vendor/MSFT/Policy  
**오프셋 URI**:/Config/Defender/AllowOnAccessProtection
...
**CSP**:./Device/Vendor/MSFT/Policy  
**오프셋 URI**:/Config/InternetExplorer/RestrictedSitesZoneAllowAccessToDataSources
...
**CSP**:./Device/Vendor/MSFT/Policy  
**오프셋 URI**:/Config/InternetExplorer/RestrictedSitesZoneAllowOnlyApprovedDomainsToUseActiveXControls
...
**CSP**:./Device/Vendor/MSFT/Policy  
**오프셋 URI**:/Config/InternetExplorer/RestrictedSitesZoneAllowOnlyApprovedDomainsToUseTDCActiveXControl
...
**CSP**:./Device/Vendor/MSFT/Policy  
**오프셋 URI**:/Config/InternetExplorer/RestrictedSitesZoneAllowVBScriptToRunInInternetExplorer
...
**CSP**:./Device/Vendor/MSFT/Policy  
**오프셋 URI**:/Config/InternetExplorer/RestrictedSitesZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**:./Device/Vendor/MSFT/Policy  
**오프셋 URI**:/Config/InternetExplorer/RestrictedSitesZoneUsePopupBlocker
...
**CSP**:./Device/Vendor/MSFT/Policy  
**오프셋 URI**:/Config/InternetExplorer/TrustedSitesZoneDoNotRunAntimalwareAgainstActiveXControls
...
**CSP**:./Vendor/MSFT/Policy  
**오프셋 URI**:/Config/ApplicationManagement/RestrictAppDataToSystemVolume
...
**CSP**: n/a-GRAPH API **오프셋 URI**: n/a-Graph API만
...
- [장치 구성 개요](../configuration/device-profiles.md)
