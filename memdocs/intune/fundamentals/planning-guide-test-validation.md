...
<blockquote>NDES(네트워크 디바이스 등록 서비스)의 요구 사항을 충족하지 못한다는 사실을 알게 되었습니다. 그리고 NDES 구현 없이 동일한 요구 사항을 충족하는 루트 CA를 사용하여 VPN 및 Wi-Fi 프로필을 구성할 수도 있다는 것도 알게 되었습니다.</blockquote>
